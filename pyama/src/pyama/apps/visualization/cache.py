...
from pyama.apps.visualization.preprocessing import VisualizationPreprocessingService
...
class VisualizationCache:
    ...
    def _resolve_cache_path(self, source_path: Path, channel_id: str) -> Path:
        ...
        base_dir = (
            self._cache_root if self._cache_root is not None else source_path.parent
        )
