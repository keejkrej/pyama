...
export default function Home() {
  ...
  const validateMerge = (): string | null => {
    ...
    if (!selections.inputDir) return "Please select an input directory (folder of processed FOVs)";
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-4">
                ...
                <div className="space-y-3 text-sm text-neutral-200">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between text-xs text-neutral-400">
                      <span>Folder of Processed FOVs</span>
                      <button
                        className="rounded-md border border-neutral-700 bg-neutral-800 px-2 py-1 text-[11px] hover:bg-neutral-700 disabled:opacity-50"
                        onClick={() =>
                          openPicker({
                            ...
                            description: "Select the folder containing fov_000, fov_001, etc.",
                            directory: true,
                          })
                        }
                        disabled={isMerging}
