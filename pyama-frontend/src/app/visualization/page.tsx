          ...
          <div className="rounded-xl border border-border bg-card p-6 shadow-sm space-y-4">
            ...
            <div className="rounded-lg border border-border bg-muted p-4">
              <div className="space-y-1">
                ...
                <div className="rounded-md border border-border bg-card px-3 py-2 text-muted-foreground truncate text-xs">
            ...
            <Button
              ...
              disabled={
                loadingProject || !outputDir || selectedChannels.length === 0
              }
            >
