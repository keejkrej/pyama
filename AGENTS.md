...
Repository guidelines for AI agents. PyAMA: pyama-core (processing, analysis, I/O) + pyama-pro (Qt GUI).
...
- **Qt**: ProcessingTab, AnalysisTab, VisualizationTab in `pyama_pro.{processing,analysis,visualization}.main_tab`
...
See [docs/](docs/) for usage, core API, plugins, protocol.
