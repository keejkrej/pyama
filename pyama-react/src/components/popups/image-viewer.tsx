      ...
      <Card title="Image Panel" className="h-full">
        <div className="flex items-center justify-center h-full min-h-[400px] text-muted-foreground">
          <div className="text-center">
            ...
            <p className="mb-2 font-medium text-foreground">Image Viewer Placeholder</p>
            <p className="text-sm">View microscopy images, navigate FOVs and time points, overlay cell masks.</p>
          </div>
        </div>
      </Card>
    </Modal>
