...
PyAMA-Qt is the Qt-based graphical user interface for PyAMA, providing comprehensive tools for microscopy image analysis through a tabbed interface featuring Processing, Visualization, and Analysis capabilities.
...
PyAMA-Qt provides a complete solution for microscope image analysis from raw data to fitted parameters, with comprehensive tools for quality control and visual inspection at every stage.
