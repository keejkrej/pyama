...
from pyama_pro.modeling.data import DataPanel
from pyama_pro.modeling.parameter import ParameterPanel
from pyama_pro.modeling.quality import QualityPanel
