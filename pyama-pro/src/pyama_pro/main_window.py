...
_TAB_SPECS = (
    ("processing_tab", "Processing", "pyama_pro.processing.main_tab", "ProcessingTab"),
    ("statistics_tab", "Statistics", "pyama_pro.statistics.main_tab", "StatisticsTab"),
    ("modeling_tab", "Modeling", "pyama_pro.modeling.main_tab", "ModelingTab"),
    ("visualization_tab", "Visualization", "pyama_pro.visualization.main_tab", "VisualizationTab"),
)
