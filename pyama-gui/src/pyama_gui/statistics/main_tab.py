...
from pyama.tasks import run_folder_statistics
from pyama_gui.statistics.comparison import StatisticsComparisonPanel
from pyama_gui.statistics.detail import StatisticsDetailPanel
from pyama_gui.statistics.load import StatisticsLoadPanel
