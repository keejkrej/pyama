...
def test_load_nd2_metadata_and_stacks(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("pyama_core.io.microscopy.nd2.ND2File", _FakeNd2File)
...
def test_load_nd2_fallback_metadata(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("pyama_core.io.microscopy.nd2.ND2File", _FakeNd2FileFallback)
...
def test_load_czi_metadata_and_stacks(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("pyama_core.io.microscopy.czi_api.CziReader", _FakeCziReader)
...
def test_czi_scene_size_mismatch_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
        "pyama_core.io.microscopy.czi_api.CziReader", _FakeCziReaderMismatch
    )
